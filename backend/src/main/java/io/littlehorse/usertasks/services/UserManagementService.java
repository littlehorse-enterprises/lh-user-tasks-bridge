...
public class UserManagementService {
    ...
    @NonNull
    public IDPUserListDTO listUsersFromIdentityProvider(
            @NonNull String accessToken,
            @NonNull IStandardIdentityProviderAdapter identityProviderAdapter,
            @NonNull IDPUserSearchRequestFilter requestFilter,
            int firstResult,
            int maxResults) {
    ...
    public void createUserInIdentityProvider(
            @NonNull String accessToken,
            @NonNull CreateManagedUserRequest requestBody,
            @NonNull IStandardIdentityProviderAdapter identityProviderAdapter) {
        Map<String, Object> params = null;
    ...
    public void setPassword(
            ...
            @NonNull UpsertPasswordRequest requestBody,
            @NonNull IStandardIdentityProviderAdapter identityProviderHandler) {
        Map<String, Object> params = Map.of(
                ACCESS_TOKEN_MAP_KEY,
                accessToken,
                "password",
                requestBody.getPassword().trim(),
                "isTemporary",
                requestBody.isTemporary());

        identityProviderHandler.setPassword(userId, params);
    }

    public Optional<IDPUserDTO> getUserFromIdentityProvider(
            @NonNull String accessToken,
            @NonNull String userId,
            @NonNull IStandardIdentityProviderAdapter identityProviderHandler) {
    ...
    public void updateUser(
            @NonNull String accessToken,
            @NonNull String userId,
            @NonNull UpdateManagedUserRequest requestBody,
            @NonNull IStandardIdentityProviderAdapter identityProviderHandler) {
    ...
    public void joinGroup(
        ...
        Map<String, Object> params =
                Map.of(ACCESS_TOKEN_MAP_KEY, accessToken, USER_ID_MAP_KEY, userId, USER_GROUP_ID_MAP_KEY, groupId);
