...
class TenantServiceTest {
    ...
    private final String STUBBED_ACCESS_TOKEN =
            "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJIbkdSc3I1eGpub1UyN0k"
                    ...
                    + "OsX_bA";
    private final String OKTA_ACCESS_TOKEN =
            "eyJraWQiOiJHWFJic1c2clV4S3J5SGJ1NjNhU0tNX1pQb1FQOF9IdTBoVng0NUViRlNJIiwiYWxnIjoi"
    ...
    void isValidTenant_shouldReturnFalseWhenServerAPIThrowsAnExceptionDifferentFromNotFoundException() {
        ...
        RuntimeException exception = assertThrows(
                RuntimeException.class, () -> tenantService.isValidTenant(tenantIdToValidate, STUBBED_ACCESS_TOKEN));
    ...
    void isValidTenant_shouldThrowExceptionWhenRequestTenantIsNotFoundWithinTheConfiguration() {
        ...
        SecurityException exception = assertThrows(
                SecurityException.class, () -> tenantService.isValidTenant(tenantIdToValidate, STUBBED_ACCESS_TOKEN));
    ...
    @Test
    void
            isValidTenant_shouldThrowResponseStatusExceptionAsInternalServerErrorWhenAnExceptionIsThrownWhileReadingClaimsFromToken() {
        var tenantIdToValidate = "someTenant";
        ...
        try (MockedStatic<TokenUtil> mockStaticTokenUtil = mockStatic(TokenUtil.class)) {
            ...
            mockStaticTokenUtil
                    .when(() -> TokenUtil.getTokenClaims(anyString()))
                    .thenThrow(new UnrecognizedPropertyException(
            ...
            ResponseStatusException exception = assertThrows(
                    ResponseStatusException.class, () -> tenantService.isValidTenant(tenantIdToValidate, "wrongToken"));
    ...
    void isValidTenant_shouldReturnFalseWhenClientIdDoesNotMatchConfigurationProperties() {
        ...
        CustomIdentityProviderProperties properties =
                getCustomIdentityProviderPropertiesWithOkta(fakeUri, configuredTenant);
    ...
    void getTenantIdentityProviderConfig_shouldReturnProviderConfigWhenThereIsAMatchingTenantConfigFound() {
        ...
        CustomIdentityProviderProperties properties =
                getCustomIdentityProviderPropertiesWithKeycloak(fakeUri, configuredTenant);
        ...
        assertEquals(
                IdentityProviderVendor.KEYCLOAK,
                foundProvidersConfig.iterator().next().getVendor());
    ...
    @Test
    void
            getTenantIdentityProviderConfig_shouldReturnProviderConfigWhenThereIsAMatchingTenantConfigFoundWithDifferentClients() {
        var configuredTenant = "default";
        var requestedTenant = "default";
    ...
    void getTenantIdentityProviderConfig_shouldReturnProviderConfigWhenThereAreSeveralMatchingTenantConfigsFound() {
        ...
        CustomIdentityProviderProperties properties1 =
                getCustomIdentityProviderPropertiesWithOkta(fakeOktaUri, configuredTenant);
        CustomIdentityProviderProperties properties2 =
                getCustomIdentityProviderPropertiesWithKeycloak(fakeKeycloakUri, configuredTenant);
        ...
        assertEquals(expectedTotalProviderConfigsCount, foundProvidersConfig.size());
        assertEquals(
                expectedOktaProviderConfigsCount,
                foundProvidersConfig.stream()
                        ...
                        .count());
        assertEquals(
                expectedKeycloakProviderConfigCount,
                foundProvidersConfig.stream()
    ...
    private CustomIdentityProviderProperties getCustomIdentityProviderPropertiesWithOkta(
            URI fakeUri, String configuredTenant) {
        ...
        SpringAddonsOidcProperties.OpenidProviderProperties.SimpleAuthoritiesMappingProperties authority =
                new SpringAddonsOidcProperties.OpenidProviderProperties.SimpleAuthoritiesMappingProperties();
        authority.setPath("$.someJsonPath.roles");

        return new CustomIdentityProviderProperties(
                fakeUri,
                fakeUsernameClaim,
                CustomUserIdClaim.EMAIL,
                fakeVendor,
                "some-okta",
                configuredTenant,
                configuredClients,
    ...
    private CustomIdentityProviderProperties getCustomIdentityProviderPropertiesWithKeycloak(
            URI fakeUri, String configuredTenant) {
        var fakeUsernameClaim = "preferred_username";
